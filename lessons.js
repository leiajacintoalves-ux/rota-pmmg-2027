...
window.PMMG_LESSONS = {
  ...
  "Português::Classes de palavras": {
    ...
    questions: [
      ...
      {
        prompt:
          "Na expressão “livro de português”, a palavra “de” é:",
        ...
        explanation:
          "De estabelece uma relação entre as palavras livro e português."
      },

      {
        prompt:
          "Assinale a frase em que a palavra destacada exerce função de pronome:",

        options: [
          "Aquele candidato foi aprovado.",
          "O candidato estudou bastante.",
          "A prova difícil terminou.",
          "A equipe chegou cedo."
        ],

        correct: 0,

        explanation:
          "Aquele acompanha o substantivo candidato e é um pronome demonstrativo."
      },

      {
        prompt:
          "Na frase “Nossa! A prova estava difícil”, a palavra “Nossa!” é:",
        ...
        explanation:
          "Nossa! expressa uma reação de espanto e funciona como interjeição."
      },

      {
        prompt:
          "Na frase “O candidato respondeu rapidamente”, a palavra “rapidamente” é:",
        ...
        explanation:
          "Rapidamente modifica o verbo respondeu e indica o modo como a ação ocorreu."
      },

      {
        prompt:
          "Assinale a alternativa em que a palavra “o” funciona como artigo:",

        options: [
          "Eu o encontrei ontem.",
          "O candidato chegou cedo.",
          "Ninguém o chamou.",
          "O diretor informou-o."
        ],

        correct: 1,

        explanation:
          "Em “O candidato”, a palavra o acompanha e determina o substantivo candidato."
      }
    ]
  }
};
