(() => {
 ...
 function getLessonData(subject, topic) {
  return (
    window.PMMG_LESSONS?.[
      `${subject}::${topic}`
    ] || null
...
function renderLessonFlashcards(
  flashcards = []
) {
  ...
  return `
    <div class="lesson-block">
      ...
      <p class="muted">
        Toque em uma pergunta para revelar
        a resposta.
      </p>
...
function renderLessonQuestions(
  questions = []
) {
  if (!questions.length) {
    return "";
  ...
  return `
    <div class="lesson-block">
      ...
      <p class="muted">
        Marque uma alternativa em cada questão
        e toque em corrigir.
      </p>
