...
function renderSubjectProgress() {
  ...
  subjectsGrid.innerHTML = `
    <article class="panel lesson-page">
      ...
      <div class="lesson-block">
        ...
        <p>
          Compreender os conceitos principais de
          <strong>${topic}</strong> e reconhecer
      ...
      <div class="lesson-block">
        ...
        <p>
          Esta é a primeira estrutura de aula do
          Rota PMMG 2027.
        </p>

        <p>
          No próximo passo, vamos inserir aqui o
          conteúdo completo da aula de
      ...
      <div class="lesson-block">
        ...
        <ul>
          <li>Identifique a ideia principal.</li>
          <li>Observe informações explícitas e implícitas.</li>
          <li>Evite responder com opinião pessoal.</li>
        </ul>
      </div>
